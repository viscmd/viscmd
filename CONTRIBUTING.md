...
<tr>
<td>args</td> <td>list of arguments</td> <td>(Not commonly used)A sequence of arguments that have close relationship.</td>
</tr>
</table>
...
We can think of the latter part as a argument value and give it a variable name. Such as:
```json
{
    "keyword": "promisc",
    "variable": "STATUS",
